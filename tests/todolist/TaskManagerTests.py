...
class TaskManagerTests(unittest.TestCase):
    ...
    def test_add_task_with_default_description_should_be_present_in_taskmanager(self, mock_datetime):
        # Arrange
    ...
    def test_mark_as_done_valid_index(self):
        # Arrange
        task_manager = TaskManager()
        task_manager.tasks = [
            {"title": "Task 1", "description": "Desc 1", "done": False, "created_at": datetime(2022, 1, 1, 12, 0, 0)},
    ...
    def test_load_tasks_file_not_found(self, mock_parse_datetime, mock_dict_reader):
        # Arrange
        task_manager = TaskManager()
    ...
    @patch("src.todolist.TaskManager.parse_datetime_with_microseconds")
    def test_load_tasks_file_found(self, mock_parse_datetime, mock_open, mock_dict_reader):
        # Arrange
        task_manager = TaskManager()
